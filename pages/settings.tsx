    ...
    <Layout title="settings" className="px-8 py-6 max-w-4xl mx-auto">
      <div className="space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-400">{t('pages.settings.subtitle')}</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="glass-effect rounded-2xl p-6 border border-white/10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-gray-200">{t('pages.settings.preferences')}</h2>
            </div>

            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">
                  {t('pages.settings.autoLogout')}
                </label>
                <select
                ...
                >
                  <option value={15}>{t('pages.settings.minutes15')}</option>
                  <option value={30}>{t('pages.settings.minutes30')}</option>
                  <option value={60}>{t('pages.settings.hour1')}</option>
                  <option value={120}>{t('pages.settings.hours2')}</option>
                  <option value={0}>{t('pages.settings.never')}</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-pure-dark border border-white/10 text-gray-100 focus:border-accent-orange/50 focus:ring-2 focus:ring-accent-orange/30 focus:outline-none transition-all duration-200"
                >
                  <option value="dark">{t('pages.settings.dark')}</option>
                  <option value="darker">{t('pages.settings.darker')}</option>
                  <option value="system">{t('pages.settings.system')}</option>
                </select>
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">
                  {t('pages.settings.defaultAliasDescription')}
                </label>
                <input
                  type="text"
                  value={settings.defaultAliasDescription}
                  onChange={(e) => saveSettings({ defaultAliasDescription: e.target.value })}
                  placeholder={t('pages.settings.autoGeneratedAlias')}
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-300">{t('pages.settings.notifications')}</span>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-300">{t('pages.settings.autoBackup')}</span>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-300">{t('pages.settings.showUsageStats')}</span>
                  </div>
                  <button
